  ...
  return (
    <section className="relative z-10 overflow-hidden pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap justify-center -mx-4 bg-transparent">
          <div className="flex flex-wrap -mx-4">
            <CourseCard
              type="Personal"
              price="$59"
  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="relative z-10 mb-10 overflow-hidden rounded-[10px] border-2 border-stroke bg-transparent px-8 py-10 shadow-Course dark:border-dark-3 dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-[50px]">
